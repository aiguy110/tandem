...
func (r *Registry) ListAnnotations(agentID string) ([]store.Annotation, error) {
	return r.store.ListAnnotations(agentID)
}
...
func (r *Registry) ClearAnnotations(agentID string) (int, error) {
	return r.store.DeleteAnnotationsForAgent(agentID)
}
